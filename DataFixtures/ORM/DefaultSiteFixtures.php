...
namespace NoM\Bundle\CMSBundle\DataFixtures\ORM;
...
class DefaultSiteFixtures extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    {
        $homepage = $this->createAndPersistPage($manager, 'NoM\Bundle\CMSBundle\Entity\HomePage', $title, null, "", "homepage");
        {
    ...
    {
        return $this->createAndPersistPage($manager, 'NoM\Bundle\CMSBundle\Entity\ContentPage', $title, $parent);
    }
    ...
    {
        $page = $this->createAndPersistPage($manager, 'NoM\Bundle\CMSBundle\Entity\FormPage', $title, $parent);
